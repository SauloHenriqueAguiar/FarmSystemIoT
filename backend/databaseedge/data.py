...
while True:
    ...
    pHpred = pd.read_csv(r'/home/shna/FarmSystemIoTDL/backend/databaseedge/predicaopH.csv', header=None)
    ...
    database = r"/home/shna/FarmSystemIoTDL/backend/databaseedge/db/bancoedgeagro.db"
