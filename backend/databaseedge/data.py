...
while True:
    ...
    pHpred = pd.read_csv(r'/home/saulo/FarmSystemIoTDL/backend/databaseedge/predicaopH.csv', header=None)
    ...
    database = r"/home/saulo/FarmSystemIoTDL/backend/databaseedge/db/bancoedgeagro.db"
