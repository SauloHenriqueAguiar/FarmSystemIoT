...
database = r"C:\Users\saulo\PrevDailyWeakly\databaseedge\db\bancosensor.db"
...
def update_graph_scatter(n):
    ...
    databasepHpred = r"C:\Users\saulo\PrevDailyWeakly\databaseedge\db\bancosensor.db"
...
def update_prev_diaria_semanal(n):
    ...
    conn = sqlite3.connect(
        'C:/Users/saulo/PrevDailyWeakly/databaseedge/db/bancosensor.db')
    cursor = conn.cursor()
